      ...
      >
        ...
        <div className="p-10">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-white hover:bg-zinc-100 active:bg-zinc-200 text-zinc-900 font-medium h-12 rounded-xl flex items-center justify-center gap-3 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
